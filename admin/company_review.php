...
if(isset($_POST))
{
   ...
   $data = [
    ...
    $sql2 ="UPDATE `company_reviews_map` SET `company_id`='".$com_id."', `review_text`='".$review_text."', `review_name`='".$review_name."',`review_stars`='".$review_stars."' WHERE id='".$id."' ";
