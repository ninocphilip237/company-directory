...
<head>
    ...
    <title>Hire My Developer | Hourly Rates</title>
    <!-- Footable CSS -->
...
<body class="skin-default-dark fixed-layout">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Hourly Rates</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Hourly Rates</li>
                            </ol>
                            <a href="manage_hourly_rate.php">
                                    ...
                                    <table id="demo-foo-addrow2" class="table m-t-30 table-hover no-wrap contact-list" data-page-size="5">
									 ...
									 <div class="m-t-40">
                                        ...
                                        $i=0;
                                            ...
                                            <td>   <?php echo $i;  ?> </td>
                                                ...
                                                <td>
													...
													<?php } ?>	
                                                    <a href="manage_hourly_rate.php?id=<?php echo $result['id']?>" >													
                                        ...
                                        <tfoot>
                                            <tr> 
                                                <td colspan="2">
												  <!-- <a href="manage_hourly_rate.php" class="btn btn-info btn-rounded">Add New Hourly Rate</button> -->
                                                </td>												
                                                <td colspan="6">
	...
	<script>
      function deleteHourlyRate(id) {
        var r = confirm("Do you want to delete this Hourly rate!");
        if (r == true) {   
          alert('Hourly Rate deleted Successfully !');
          document.location.href='delete_hourly_rate.php?dlt_id='+id;
        } 
     
      }
	  function changeHourlyRateStatus(id,flag) {
        var r = confirm("Do you want to change the status of this Hourly rate!");
        if (r == true) {   
          alert('Hourly Rate Status Changed Successfully !');
          document.location.href='status_hourly_rate.php?id='+id+'&flag='+flag;
        } 
