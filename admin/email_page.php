                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="">
                                    ...
                                    if($a!=""){
                                        ...
                                        ?>
                                <textarea id="mymce" name="area" value="<?php echo $template['template'];?>"><?php echo $a; ?></textarea>
                                <?php }
                                else{?>
                              ...
                              <?php  } ?>
                                    ...
                                    <a href="locations.php" class="btn btn-inverse cancel-button">Cancel</a>
                                    </div>
