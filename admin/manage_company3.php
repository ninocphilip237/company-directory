...
if(isset($_POST))
{
   ...
   if($query2-> execute($data)){
    ...
    unset($_SESSION['step2']);
		echo "<script type=text/javascript>";
		echo "alert('Company Step3 Updated Successfully...!');";
		echo "document.location.href='companies.php'";
		echo"</script>";
    }
    else
    {
        ...
        <div class="card-body">
            ...
            <div class="vtabs customvtab col-12">
                <ul class="nav nav-tabs tabs-vertical" role="tablist">
                    ...
                    <li class="nav-item"> <a class="nav-link active"  href="manage_company3.php<?php if($id!='') echo '?id='.$id; ?>" ><span class="hidden-sm-up"><i class="ti-control-forward"></i></span> <span class="hidden-xs-down">Step 3</span></a> </li>
                </ul>
                <!-- Tab panes -->
                    ...
                    <div class="tab-pane active" >
                        ...
                        <form class="form-material m-t-40 row"  method="post" enctype="multipart/form-data" >                         
                            <div class="form-group col-md-12 pt-5 pb-3 d-flex justify-content-between">
                                ...
                                <a href="manage_customer.php?com_id=<?php echo $id; ?>"  class="btn btn-info"><i class="fa fa-plus"></i>&nbsp;Add New</a>                          
                             ...
                             <div class="form-group col-md-12 border p-2 d-flex justify-content-between">
                                ...
                                <div class="col-md-6"> 
                                    ...
                                    <a href="manage_customer.php?com_id=<?php echo $customer['company_id']; ?>&id=<?php echo $customer['id']; ?>"  class="btn btn-info"><i class="fa fa-pencil"></i>&nbsp;Edit</a> 
                            ...
                            <div class="form-group col-md-12 pt-5 pb-3 d-flex justify-content-between">
                                ...
                                <a href="manage_testimonial.php?com_id=<?php echo $id; ?>"  class="btn btn-info"><i class="fa fa-plus"></i>&nbsp;Add New</a>                          
                             ...
                             <div class="form-group col-md-12 border p-2 d-flex justify-content-between">
                                ...
                                <div class="col-md-6"> 
                                    ...
                                    <a href="manage_testimonial.php?com_id=<?php echo $testimonial['company_id']; ?>&id=<?php echo $testimonial['id']; ?>" class="btn btn-info"><i class="fa fa-pencil"></i>&nbsp;Edit</a> 
                            ...
                            <div class="form-group col-md-12 pt-5 pb-3 d-flex justify-content-between">
                                ...
                                <a href="manage_review.php?com_id=<?php echo $id; ?>" class="btn btn-info"><i class="fa fa-plus"></i>&nbsp;Add New</a>                                
                            </div>
                             ...
                             <div class="form-group col-md-12 border p-2 d-flex justify-content-between">
                                ...
                                <div class="col-md-6"> 
                                    ...
                                    <a href="manage_review.php?com_id=<?php echo $review['company_id']; ?>&id=<?php echo $review['id']; ?>"  class="btn btn-info"><i class="fa fa-pencil"></i>&nbsp;Edit</a> 
                            ...
                            <div class="col-md-12 text-xs-right">
                                ...
                                <?php } ?>
                                  &nbsp;  <a href="companies.php" class="btn btn-inverse" >Skip</a>
                            </div>
                        </form>
                    </div>
                </div>
