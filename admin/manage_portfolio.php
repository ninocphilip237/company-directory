...
if(isset($_POST))
{
   if(isset($_FILES['image']['tmp_name'])) {
	...
	// Check if image file is a actual image or fake image
	  ...
	  if($check !== false) {
		...
		echo "document.location.href='manage_company2.php?id=".$com_id."'";
		echo"</script>";
		exit();
		$uploadOk = 0;
	  }
   ...
   $data = [
    ...
    $sql2 ="UPDATE `company_portfolio_map` SET `company_id`=:company_id, `portfolio_title`=:portfolio_title,`image`=:image,`reference_link`=:reference_link WHERE id=:id";
   }
   else
   {
	$data = [
    ...
    $sql2 ="UPDATE `company_portfolio_map` SET `company_id`=:company_id, `portfolio_title`=:portfolio_title,`reference_link`=:reference_link WHERE id=:id";
   }
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><a href="manage_company2.php?id=<?php echo $com_id; ?>">Portfolios</a></li>
            ...
            <div class="login-box card">
                <div class="card-body">
                                ...
                                <form class="m-t-40" method="post" enctype="multipart/form-data" >
									...
									<?php } ?>
                                        <a href="manage_company2.php?id=<?php echo $com_id; ?>" class="btn btn-inverse">Cancel</a>
                                    </div>
                                </form>
                </div>
            </div>
