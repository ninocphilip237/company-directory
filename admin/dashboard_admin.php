...
$stmt1 = $conn->query('SELECT * FROM states');
$states_count = $stmt1->rowCount();

$stmt2 = $conn->query('SELECT * FROM cities');
$cities_count = $stmt2->rowCount();

$stmt3 = $conn->query('SELECT * FROM locations');
$locations_count = $stmt3->rowCount();

$stmt4 = $conn->query('SELECT * FROM services');
$services_count = $stmt4->rowCount();

$stmt5 = $conn->query('SELECT * FROM companies');
$companies_count = $stmt5->rowCount();

$stmt6 = $conn->query('SELECT * FROM email_template');
$emailt_count = $stmt6->rowCount();

$stmt7 = $conn->query('SELECT * FROM company_reviews_map');
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        ...
                                        <div class="ml-auto">
                                            <h2 class="counter text-success"><?php echo $users_count; ?></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        ...
                                        <div class="ml-auto">
                                            <h2 class="counter text-primary"><?php echo $emailt_count; ?></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
