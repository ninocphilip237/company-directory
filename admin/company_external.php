...
else
{
  ...
  echo "alert('Not Authorised to access this page !');";
  echo "document.location.href='index.php'";
  echo"</script>";
  exit();
}

$id = $c_name = $c_description = $c_address = $c_url = $c_email = $c_contact = $m_title = $m_description = $m_keywords = $state_id = $city_id= $loc_id = $location_id = $serv_id = $logo = $logo_new = $states  = $cities = $locations = $services = $service_map = $location_map = $selected_states = $selected_cities = $selected_locations = "";

$service_ids = $selected_serv = [];
$status = $flag = $p_progress = 0;
$profile_progress = 33;
...
$encrypt_last_id = openssl_encrypt($orig_string, $ciphering,$encryption_key, $options, $encryption_iv);
   ...
   if(isset($_FILES['logo']['tmp_name'])) {
	...
	// Check if image file is a actual image or fake image
	  ...
	  if($check !== false) {
        ...
        if($id!=''){
          echo "document.location.href='company_external.php?id=".$encrypt_last_id."'";
        }
        else
        {
   ...
   $data = [
    ...
    $sql2 ="UPDATE `companies` SET  `company_name`=:company_name, `company_description`=:company_description, `logo`=:logo, `website_url`=:website_url, `address`=:address, `email`=:email, `phone`=:phone, `meta_title`=:meta_title, `meta_description`=:meta_description, `meta_keywords`=:meta_keywords, `status`=:status WHERE id=:id";
   }
   else
   {
	$data = [
    ...
    $sql2 ="UPDATE `companies` SET  `company_name`=:company_name, `company_description`=:company_description, `website_url`=:website_url, `address`=:address, `email`=:email, `phone`=:phone, `meta_title`=:meta_title, `meta_description`=:meta_description, `meta_keywords`=:meta_keywords WHERE id=:id";
   }
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><a  onclick="clearStorage();"  href="companies.php">Companies</a></li>
    ...
    ?>
            ...
            <div class="vtabs customvtab col-12">
                <ul class="nav nav-tabs tabs-vertical" role="tablist">
                    <li class="nav-item"> <a class="nav-link active"   href="company_external.php<?php if($id!='') echo '?id='.$encrypt_last_id; ?>" ><span class="hidden-sm-up"><i class="ti-control-forward"></i></span> <span class="hidden-xs-down">Step 1</span> </a> </li>
                    ...
                    <li class="nav-item"> <a class="nav-link"  href="company_external3.php<?php if($id!='') echo '?id='.$encrypt_last_id; ?>"  ><span class="hidden-sm-up"><i class="ti-control-forward"></i></span> <span class="hidden-xs-down">Step 3</span></a> </li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div class="tab-pane active" >
                    
                        <form class="form-material m-t-40 row" name="comp-details" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="controls d-flex align-items-center">
                                    ...
                                    <input type="file" name="logo"  id="logo" accept='image/*' onkeyup='saveValue(this);'  class="form-control" <?php if ($id != '') {?> style="box-shadow: none;border: none;line-height: initial;"  <?php } else {?> required data-validation-required-message="This field is required." <?php }?> >
                                    </div>
                            </div>
                            <div class="form-group col-md-6">
                                <h5>Company Name <span class="text-danger">*</span></h5>
                                <div class="controls">
                                    <input type="text" name="company_name" id="company_name"  onkeyup='saveValue(this);' class="form-control" required data-validation-required-message="This field is required." value="<?php echo $c_name;?>"> 
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="controls">
                                    <input type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" name="email" id="email" class="form-control"  onkeyup='saveValue(this);'  required data-validation-required-message="This field is required." value="<?php echo $c_email;?>"> 
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4 d-flex">
                                ...
                                <a href="company_external.php<?php $flag++; if($id!=''){ echo '?id='.$encrypt_last_id.'&flag='.$flag; } else { echo  '?flag='.$flag; } ?>" class="add_button btn btn-primary ml-5" title="Add New Location"><i class="fa fa-plus"></i> &nbsp;Add New</a>
                            </div>
                    ...
                    if($location_map==''){ ?>
                        <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                <!-- <h5>Location <span class="text-danger">*</span></h5> -->
                                <div class="controls">
                                    <select class="select2 form-control custom-select" id="location<?php echo $select_count; $select_count++; ?>" name="location[]" style="width: 100%; height:36px;" required data-validation-required-message="This field is required.">
                 ...
                 ?>
                       ...
                       <?php } } ?>         
                            <div class="form-group col-md-8">
                                <h5>Services </h5>
                                <div class="controls">
                                    <select class="select2 form-control custom-select" id="service" name="service[]" placeholder="Select Service" required data-validation-required-message="This field is required" multiple style="width: 100%; height:36px;" >
                            ...
                            <div class="form-group col-md-10">
                                ...
                                <div class="controls">
                                    <textarea name="company_description" rows="10" id="company_description" class="textarea_editor form-control" required data-validation-required-message="This field is required." placeholder="Enter Text Here..."  onkeyup='saveValue(this);' style="border:1px solid #4F5467;" ><?php echo $c_description;?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="controls">
                                    <input type="text" value="<?php echo $m_title;?>"  onkeyup='saveValue(this);' name="meta_title" class="form-control" required data-validation-required-message="This field is required."> 
                                </div>                              
                            </div> 
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="controls">
                                    <input type="text"  required data-validation-required-message="This field is required"   onkeyup='saveValue(this);' data-role="tagsinput" id="meta_keywords" name="meta_keywords" value="<?php echo $m_keywords;?>" class="form-control w-100" > 
                                </div>
                            </div>
                            ...
                            <div class="text-xs-right">
                                ...
                                <?php } ?>
                                  &nbsp;  <a href="../index.php" onclick="clearStorage();"  class="btn btn-inverse">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
