...
?>
            ...
            <div class="vtabs customvtab col-12">
                <ul class="nav nav-tabs tabs-vertical" role="tablist">
                    ...
                    <li class="nav-item"> <a class="nav-link active"  href="company_external2.php<?php if($id!='') echo '?id='.$encrypt_last_id; ?>" ><span class="hidden-sm-up"><i class="ti-control-forward"></i></span> <span class="hidden-xs-down">Step 2</span></a> </li>
                    <li class="nav-item"> <a class="nav-link"  href="company_external3.php<?php if($id!='') echo '?id='.$encrypt_last_id; ?>"  onclick="myfun();" ><span class="hidden-sm-up"><i class="ti-control-forward"></i></span> <span class="hidden-xs-down">Step 3</span></a> </li>
                </ul>
                <!-- Tab panes -->
                    ...
                    <div class="tab-pane active" >
                        ...
                        <form class="form-material m-t-40 row"  method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-group col-md-12 pt-5 pb-3 d-flex justify-content-between">
                                ...
                                <a href="company_portfolio.php?com_id=<?php echo $encrypt_last_id; ?>" class="btn btn-info"><i class="fa fa-plus"></i>&nbsp;Add New</a>                          
                            </div>
                        <?php foreach ($portfolios as $portfolio) { ?>
                             <div class="form-group col-md-12 border pb-3">
                                ...
                                $portfolio_id = openssl_encrypt($port_id, $ciphering,$encryption_key, $options, $encryption_iv);
                            ?>
                                <div class="col-md-12 d-flex"> 
                                      ...
                                      <div class="col-md-10">
                                        ...
                                        <a href="company_portfolio.php?com_id=<?php echo $company_id; ?>&id=<?php echo $portfolio_id; ?>" class="btn btn-info"><i class="fa fa-pencil"></i>&nbsp;Edit</a> 
                        ...
                        <?php } ?> 
                            ...
                            <div class="col-md-12 text-xs-right">
                                ...
                                <?php } ?>
                                  &nbsp;  <a href="company_external3.php<?php if($id!='') echo '?id='.$id; ?>" class="btn btn-inverse">Skip</a>
                            </div>
                        </form>
                    </div>
                </div>
