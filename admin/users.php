...
<head>
    ...
    <title>Hire My Developer | Users</title>
    <!-- Footable CSS -->
...
<body class="skin-default-dark fixed-layout">
                            ...
                            <div class="table-responsive">
                                <table id="demo-foo-addrow2" class="table m-t-30 table-hover no-wrap contact-list"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="label label-table label-success"><i class="fa fa-check">
                                                    </i> Active</span>
                                                <?php } else { ?>
                                                <span class="label label-table label-danger">Diabled</span>
                                                <?php } ?>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0)"
                                                    ...
                                                    onclick="changeLocationStatus('<?php echo $result['id'] ?>',1);">Enable</a>
                                                <?php } else { ?>
                                                <a href="javascript:void(0)"
                                                    class="btn btn-xs btn-rounded btn-outline-danger"
                                                    onclick="changeLocationStatus1('<?php echo $result['id'] ?>',0);">Disable</a>
                                                <?php } ?>
                                                <a href="manage_users.php?id=<?php echo $result['id']?>">
                                                    <button type="button"
                                                        class="btn btn-sm btn-icon btn-pure btn-outline"
                                                        data-toggle="tooltip" data-original-title="Edit"><i
                                                            class="ti-pencil" aria-hidden="true"></i></button>
                                                </a>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="2">
                                                <!-- <a href="manage_users.php" class="btn btn-info btn-rounded">Add New Location</button> -->
                                            </td>
                                            <td colspan="6">
    ...
    function deleteLocation(id) {
        ...
        if (r == true) {
            ...
            document.location.href = 'delete_users.php?dlt_id=' + id;
        }

    }

    function changeLocationStatus(id, flag) {
        var r = confirm("Do you want to Enable this user !");
        if (r == true) {
            alert('User Status Changed Successfully !');
            document.location.href = 'status_users.php?id=' + id + '&flag=' + flag;
        }

    }
    function changeLocationStatus1(id, flag) {
        var r = confirm("Do you want to Disable this user !");
        if (r == true) {
            alert('User Status Changed Successfully !');
            document.location.href = 'status_users.php?id=' + id + '&flag=' + flag;
        }
